<template>
  <div class="video-panel" :class="{'video-panel-mini':isMini,'video-panel-fullscreen':isfullscreen,'video-panel-normal':!isfullscreen&&!isMini}">
    <div class="tools-box">
      <div class="tv_box" style="float: right;">
        ...
        <span @click="changeVideoBoxNum(8)"><i class="icon icon_num3"/></span>
    ...
    <div :class="'video-box '+videoBoxStyle">
      ...
      >
        <div v-if="!item.url" class="no-source">
          <img src="./static/images/video.svg" width="32" alt="">
