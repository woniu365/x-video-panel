  ...
  <div class="video-panel" :class="{'video-panel-mini':!isfullscreen,'video-panel-fullscreen':isfullscreen}">
    <div class="tools-box">
      <div class="tv_box" style="float: right;">
        <span @click="changeVideoWindowsNum(1)"><i class="icon icon_num1"/></span>
        <span @click="changeVideoWindowsNum(4)"><i class="icon icon_num2"/></span>
        <span @click="changeVideoWindowsNum(6)"><i class="icon icon_num3"/></span>
        <span @click="changeVideoWindowsNum(9)"><i class="icon icon_num5"/></span>
    ...
    methods:
      {
        ...
        changeVideoWindowsNum(num) {
          window.localStorage.setItem('video_window_num', num)
...
<style lang="less" scoped>
  ...
  .video-panel-mini {
    ...
    .video-box {
      ...
      min-width: @min-width;
      min-height: calc(@min-width * 0.75);
      width: @vw;
      height: calc(@vw * 0.75);
    }
  }
